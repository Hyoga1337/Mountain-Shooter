...
from Const import C_WHITE, C_YELLOW, MENU_OPTION, SCORE_POS
        ...
        while True:
            ...
            if game_mode == MENU_OPTION[2]:
                if player_score[0] >= player_score[1]:
                    title = 'PLAYER1 WINS!!'
                    score = player_score[0]
                    text = f'Enter Player1 name (4 characters):'
                else:
                    title = 'PLAYER2 WINS!!'
                    score = player_score[1]
                    text = f'Enter Player2 name (4 characters):'
            self.score_text(48, f'{title}', C_YELLOW, SCORE_POS['Title'])
